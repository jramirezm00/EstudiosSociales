        ...
        <div className="game">
          ...
          <div className="question">
            <div className="boxquestion">
              Desde la colonización española de América, es decir a partir del
              siglo XVI, en lengua española se llama así a los seres humanos
              nacidos de la unión entre una persona blanca (en general, durante
              la colonización de América, de ascendencia española o europea) y
              una persona negra.
            </div>
